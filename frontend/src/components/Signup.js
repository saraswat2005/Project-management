...
export const Signup = () => {
    ...
    const {createUser, clearCredentials, getAlert} = value
            ...
            <div
                ...
                <div
                    ...
                    <div>
                        ...
                        <p className="text-[13px] text-gray-300 mt-3 leading-relaxed">Welcome to our registration page!
                    ...
                    <div>
                        ...
                        <p className="text-[13px] text-gray-300 mt-3 leading-relaxed">Our registration process is
                            designed to be straightforward and secure. We prioritize your privacy and data security.</p>
                    </div>
                </div>
                ...
                <form className="md:col-span-2 w-full py-6 px-6 sm:px-16">
                    ...
                    <div className="space-y-6">
                        ...
                        <div>
                            ...
                            <div className="relative flex items-center">
                                <input name="password" onChange={onChange} type="password" required
                                       className="text-gray-800 bg-white border border-gray-300 w-full text-sm px-4 py-2.5 rounded-md outline-blue-500"
