...
export const AddProject = (props) => {
    ...
    const [projectDetails, setProjectDetails] = useState({title: "", manager: "", desc: ""})
    const onChange = (e) => {
    ...
    const submitForm = async() => {
        ...
        createProject(projectDetails, credentials)
        navigate('/projects')
    }
    return (<>
        <div className="body">
            ...
            <div className="addProjectForm">
                <form className="font-[sans-serif] m-6 max-w-4xl mx-auto">
                    <div className="grid sm:grid-cols-2 gap-10 projectAddForm">
                        ...
                        <div className="relative flex items-center sm:col-span-2">
                            <label
                                className="text-[13px] bg-white text-black absolute px-2 top-[-10px] left-[18px]">Manager</label>
                            <input type="text" name={"manager"} placeholder="Who manages this?" onChange={onChange}
