                    ...
                    <div
                        ...
                        <div className="md:max-w-md w-full px-4 py-4">
                            <form>
                                <div className="mb-12">
                                    ...
                                    <p className="text-sm mt-4 text-gray-800">Don't have an account <a
                                ...
                                <div className="space-x-6 flex justify-center mt-6">
                                    <button type="button"
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="32px" className="inline"
                                             viewBox="0 0 512 512">
                                            <path fill="#fbbd00"
                        ...
                        <div className="md:h-full bg-[#000842] rounded-xl lg:p-12 p-8">
                            <img src="https://readymadeui.com/signin-image.webp"
                                 className="w-full h-full object-contain" alt="login-image"/>
                        </div>
                    </div>
                </div>
            </div>
